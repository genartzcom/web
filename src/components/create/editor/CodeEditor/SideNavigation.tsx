...
interface SideNavigationProps {
  activeTab: 'code' | 'metadata' | 'contract';
  setActiveTab: (tab: 'code' | 'metadata' | 'contract') => void;
}
  ...
  return (
    <div className="flex w-64 min-w-64 flex-none flex-col border-r border-neutral-600">
      ...
      <div className="flex flex-col">
        ...
        <button
          className={`flex cursor-pointer items-center gap-1 px-6 py-3 font-medium transition ${
            activeTab === 'contract' ? 'bg-neutral-600 text-neutral-200' : 'text-neutral-300/75 hover:bg-neutral-700'
          }`}
